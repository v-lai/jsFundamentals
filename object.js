...
// 3. Using the delete keyword, write the command to remove the jokes key from 
//  the programming object.
delete programming.jokes;

// 4. Write the command to add a new key called isFun and a value of true to 
//  the programming object.
programming.isFun = true;

// 5. Using a loop, iterate through the languages array and console.log all of 
//  the languages.
